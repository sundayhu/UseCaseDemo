...
void CPropertiesWnd::InitPropList()
{
	...
	CMFCPropertyGridProperty* pGroup = new CMFCPropertyGridProperty(_T("属性"));

	//pGroup->AddSubItem(new CMFCPropertyGridProperty("时间"));
	pGroup->AddSubItem(new CMFCPropertyGridProperty(_T("用户"), (_variant_t)_T("用户"), _T("用户")));
	//pGroup->AddSubItem(new CMFCPropertyGridProperty(_T("用例"), (_variant_t)_T("用例"), _T("用例")));
	//pGroup->AddSubItem(new CMFCPropertyGridProperty(_T("关系"), (_variant_t)_T("关系"), _T("关系")));
...
void CPropertiesWnd::SetProperties(CString str)
{
	CMFCPropertyGridProperty* pProp = m_wndPropList.GetProperty(0);
	pProp->GetSubItem(0)->SetValue((_variant_t)str);
	//pProp->GetSubItem(1)->SetValue((_variant_t)obj->m_Actor.m_Usercase[0].name);
	//pProp->GetSubItem(2)->SetValue((_variant_t)obj->m_Actor.m_Usercase[0].type );
}
